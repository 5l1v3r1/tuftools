...
def usage():
    print "./tufdos.py -t <target> [-r <threads> -p <port> -T -h]"
    print " -t|--target <Hostname|IP>"
    print " -r|--threads <Number of threads> "
    print " -p|--port <Web Server Port> "
    print " -T|--tor Enable anonymising through tor "
    print " -h|--help Shows this help\n" 
    print "Eg. ./tufdos.py -t 173.473.23.3 -r 3074\n"
...
if __name__ == "__main__":
    ...
    print "    $     $$$$    $ "
    print "\n/*"
    print " * Team TUF DoS Testing Tool"
    print " * Version 1.0 Beta"
    print " * Anon-ymized via Tor"
    print " * We are TUF."
    print " * We do not give 2nd chances."
    print " * We do not hesitate to take action."
    print " * We do not take poor treatment kindly."
    print " * Expect us!"
    print " */\n"
